...
<body style="height: 989px">
    ...
    <div style="height: 588px">
        <p>Seleccionar Asignatura  :</p>
          ...
          <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="AsigProfe" DataTextField="codigoasig" DataValueField="codigoasig" Width="165px" AutoPostBack="True">
          </asp:DropDownList>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="Button3InsertarTarea" runat="server" Height="34px" Text="Insertar Nueva Tarea" Width="202px" PostBackUrl="~/InsertarTarea.aspx" />
